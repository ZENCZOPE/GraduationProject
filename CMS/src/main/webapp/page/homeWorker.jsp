...
<link href="<%=request.getContextPath()%>/css/homeWorker.css" rel="stylesheet">
</head>
<body>
<div id="head">
	<div id="head_left">
	...
	<ul class="left_items">
		<li>
			...
			<ul id="second_menu1" class="second_menu" style="display: none;">
		        <li onclick="addUser()"><a>新建用户</a></li>
		...
		<li>
			...
			<ul id="second_menu1" class="second_menu" style="display: none;">
				<li onclick="uploadPage()"><a>资质上传</a></li>
		...
		<li>
			...
			<ul id="second_menu1" class="second_menu" style="display: none;">
				...
				<li onclick="gameQuery()"><a>查询赛程</a></li>
			</ul>
		</li>
		<li>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/homeWorker.js"></script>
</html>
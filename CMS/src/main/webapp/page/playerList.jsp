...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/css/playerList.css">
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/css/base.css">

</head>
<body onload="queryPlayerList(1)">
	<div class="pd-10 myinput" id = "queryId">
		...
		<button type="button" onclick="queryPlayerList(1)">查询</button>
	</div>
...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/playerList.js"></script>
